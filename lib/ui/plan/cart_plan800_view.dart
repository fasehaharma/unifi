...
class CartPlan800View extends StatelessWidget {
  const CartPlan800View({Key? key}) : super(key: key);
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            Row(
              children: [Text('800mbps'), Spacer(), Text('RM 349')],
            ),
            SizedBox(
              height: 15,
            ),
            ...
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text(
                'Best for homes with 10 or more family members connected on multiple devices',
                style: TextStyle(
                  fontSize: 14,
                  color: Colors.black,
                ),
              ...
              child: ExpandablePanel(
                ...
                expanded: Column(
                  ...
                  children: [
                    ...
                    Text('• 10+ users on multiple devices'),
                    Text('• Download speed up to 800mbps'),
                    Text('• Upload speed up to 200mbps'),
            ...
            TextButton(
                onPressed: () {
                  Navigator.of(context).pushNamed('/installation-page',
                      arguments: PlanArgument('800Mbps', 'RM 349'));
                },
